...
BDI_WSGI_THREADED=1
BDI_DB_JOURNAL_MODE=WAL
BDI_DB_SYNCHRONOUS=NORMAL
BDI_DB_BUSY_TIMEOUT_MS=7000
BDI_DB_CACHE_SIZE_KB=65536
BDI_DB_MMAP_SIZE_BYTES=268435456
BDI_DB_TEMP_STORE_MEMORY=1
BDI_ADMIN_EMAIL=$ADMIN_EMAIL
BDI_ADMIN_PASSWORD=$ADMIN_PASSWORD
ENV
