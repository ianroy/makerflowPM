...
class AuditLogUpdateTable extends _i1.UpdateTable<AuditLogTable> {
  ...
  _i1.ColumnValue<int, int> actorUserInfoId(int? value) => _i1.ColumnValue(
    table.actorUserInfoId,
    value,
  );
  ...
  _i1.ColumnValue<String, String> payloadHash(String? value) => _i1.ColumnValue(
    table.payloadHash,
    value,
  );
...
class AuditLogTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnInt actorUserInfoId;
  ...
  late final _i1.ColumnString payloadHash;
